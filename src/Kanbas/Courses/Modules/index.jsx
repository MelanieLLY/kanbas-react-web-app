  ...
  <ul id="wd-modules" className="list-group rounded-0">
    ...
    <li className="wd-module list-group-item p-0 mb-5 fs-5 border-gray">
      ...
      <ul className="wd-lessons list-group rounded-0">
        ...
        <li className="wd-lesson list-group-item p-3 ps-1"><BsGripVertical className="me-2 fs-3" />Basic HTML tags and structure<LessonControlButtons /></li>
        <li className="wd-lesson list-group-item p-3 ps-1"><BsGripVertical className="me-2 fs-3" />Creating our first website<LessonControlButtons /></li>
      </ul>
    </li>
    ...
    <li className="wd-module list-group-item p-0 mb-5 fs-5 border-gray">
      ...
      <ul className="wd-lessons list-group rounded-0">
        ...
        <li className="wd-lesson list-group-item p-3 ps-1"><BsGripVertical className="me-2 fs-3" />Understanding CSS selectors<LessonControlButtons /></li>
      </ul>
    </li>
