...
<div id="wd-css-styling-tables">
  ...
  <table className="table">
    ...
    <tbody>
      <tr className="table-warning"><td>Q1</td><td>HTML</td><td>2/13/21</td><td>85</td></tr>
      <tr className="table-danger"><td>Q2</td><td>CSS</td><td>2/10/22</td><td>90</td></tr>
      <tr className="table-primary"><td>Q3</td><td>JavaScript</td><td>2/17/23</td><td>90</td></tr>
    </tbody>
    <tfoot>
