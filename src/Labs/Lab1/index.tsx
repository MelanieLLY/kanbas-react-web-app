...
tag to tell browsers to render the gaps.
  ...
  <li>Mix Chicken breast, oil, salt and pepper</li>
    <li>Wait 15 mintues.</li>
    <li>Put them to oven.</li>
  </ol>
</div>
...
<ul id="wd-your-books">
<li>The journey to the west</li>
  <li> Dream of the Red Chamber or The Story of the Stone</li>
...
<div id="wd-tables">
  ...
  <br />
  <img id="wd-teslabot" src="images/TeslaBot.webp"     width="400px" />
</div>
<div id="wd-forms">
  <h4>Form Elements</h4>
  <form id="wd-text-fields">
    ...
    <label htmlFor="wd-text-fields-midlle-name">Midlle name:</label>
    <input type="text" id="wd-text-fields-midlle-name" placeholder="Doe"
      value="B." title="The midlle name" />
  </form>
</div>
<h5>Text boxes</h5>
...
<input type="radio" name="radio-genre" id="wd-radio-drama" checked/>
...
Please
<a id="wd-github" href="https://www.lipsum.chttps://github.com/MelanieLLY/kanbas-react-web-appom"> click here </a>
to get my Github<br/>
